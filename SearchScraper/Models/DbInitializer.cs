namespace SearchScraper.Models
{
    public class DbInitializer
    {
        ...
        {
            SearchScraperDbContext context = applicationBuilder.ApplicationServices.CreateScope().ServiceProvider.GetRequiredService<SearchScraperDbContext>();
            ...
            if (!context.SearchResults.Any())
            {
                ...
                context.AddRange(searchResults);
            }
            context.SaveChanges();
        }
    }
